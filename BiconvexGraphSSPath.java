...
public class BiconvexGraphSSPath {
	// public static String ah[] =new String[26];
	public static String ah[] = { "", "S1", "S2", "S3", "S4"};
	public static String ch[] = { "", "T1", "T2", "T3","T4","T5","T6"};
	public static String order[] = { "", "S1", "T1", "S2", "S3", "T2","S4", "T3","T4","T5","T6"};
	public static int left[] = {0, 0, 1, 0, 0, 1, 0, 1,3,3,6};
	...
	public static void main(String args[]) throws IOException {
		File file = new File("BiconvexPathSSPath.txt");
